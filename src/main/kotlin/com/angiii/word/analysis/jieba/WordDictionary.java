...
public class WordDictionary {
    ...
    public void init(Path configFile) {
        ...
        synchronized (WordDictionary.class) {
            ...
            try {
                ...
                // e.printStackTrace();
                System.err.printf(Locale.getDefault(), "%s: load user dict failure!%n", configFile.toString());
            }
        }
    }
    ...
    public void loadUserDict(Path userDict, Charset charset) {
        try {
            ...
            System.out.printf(Locale.getDefault(), "user dict %s load finished, tot words:%d, time elapsed:%dms%n", userDict.toString(), count, System.currentTimeMillis() - s);
            br.close();
        } catch (IOException e) {
            System.err.printf(Locale.getDefault(), "%s: load user dict failure!%n", userDict.toString());
        }
    }
